...
public class DataInitializer implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        // 1. 프로필 생성
        List<MentoCareer> career1 = List.of(
                MentoCareer.builder()
                        .companyName("삼성전자")
        ...
        List<MentoCareer> career2 = List.of(
                MentoCareer.builder()
                        .companyName("kakao")
                        .position("프론트엔드 개발자")
                        .startDate("2012-03")
        ...
        Member mento1 = Member.mento("mento1@naver.com", "010-1111-1111", "홍길동", null, OAuthProvider.KAKAO, "oauth_id_1", mentoProfile1);
        Member mento2 = Member.mento("mento2@naver.com", "010-2222-2222", "이순신", null, OAuthProvider.KAKAO, "oauth_id_2", mentoProfile2);
