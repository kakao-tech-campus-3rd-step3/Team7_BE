...
public class DataInitializer implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        MentorProfile mentorProfile1 = MentorProfile.of(
            ...
            List.of(MentorExpertise.of("Java"), MentorExpertise.of("Spring Boot"), MentorExpertise.of("JPA")),
            "구글 시니어 개발자입니다.",
            career1,
            0.0
        );
        ...
        MenteeProfile menteeProfile1 = MenteeProfile.of(
            ...
            "컴퓨터공학과",
            2026,
            List.of(MenteeWishCompany.of("카카오"), MenteeWishCompany.of("라인"), MenteeWishCompany.of("네이버")),
