...
public class MentorQueryController {
    ...
    public ApiResponse<MentorListPageResponse> getMentors(
        ...
        MentorListPageResponse result= mentorQueryService.getMentors(search, page, size, sortBy, sortOrder);
    ...
    public ApiResponse<MentorIntroductionResponse> getMentorIntroduction(@PathVariable Long mentorId) {
